...
namespace App.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<AnalyseClient> AnalysesClients { get; set; }
        
        // ========== 2. Gestion de la Relation Fournisseur (SRM) ==========
        public DbSet<Fournisseur> Fournisseurs { get; set; }
        public DbSet<ContactFournisseur> ContactFournisseurs { get; set; }
        public DbSet<PerformanceFournisseur> PerformancesFournisseurs { get; set; }
        
        // ========== 3. Gestion des Ressources Humaines ==========
        public DbSet<Employe> Employes { get; set; }
        public DbSet<ActiviteEmploye> ActivitesEmployes { get; set; }
        ...
        public DbSet<LigneDemandeAchat> LigneDemandesAchat { get; set; }
        ...
        // ========== 9. Ressources Humaines - Paie ==========
        // Already defined above with other HR entities
        
        // ========== 10. Reporting (These are typically not DbSets as they're for reporting purposes) ==========
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure entities to avoid OUTPUT clause issues with triggers
            modelBuilder.Entity<LigneCommandeAchat>().ToTable(tb => tb.UseSqlOutputClause(false));
            modelBuilder.Entity<LigneCommandeVente>().ToTable(tb => tb.UseSqlOutputClause(false));
            modelBuilder.Entity<LigneDevis>().ToTable(tb => tb.UseSqlOutputClause(false));
            modelBuilder.Entity<LigneFactureAchat>().ToTable(tb => tb.UseSqlOutputClause(false));
            modelBuilder.Entity<LigneFactureVente>().ToTable(tb => tb.UseSqlOutputClause(false));
            modelBuilder.Entity<LigneReception>().ToTable(tb => tb.UseSqlOutputClause(false));
            ...
            // Configure HR Payroll relationships
            modelBuilder.Entity<Employe>()
                .HasOne(e => e.SituationFamiliale)
                .WithOne(sf => sf.Employe)
                .HasForeignKey<SituationFamiliale>(sf => sf.EmployeId)
                .OnDelete(DeleteBehavior.Cascade);
        
            modelBuilder.Entity<Employe>()
                .HasMany(e => e.EtatsDePaie)
                .WithOne(ep => ep.Employe)
